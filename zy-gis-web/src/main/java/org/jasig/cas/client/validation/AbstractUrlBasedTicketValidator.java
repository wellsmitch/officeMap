...
public abstract class AbstractUrlBasedTicketValidator implements TicketValidator {
    ...
    protected final String constructValidationUrl(final String ticket, final String serviceUrl) {
        ...
        if (!casServerUrlPrefix.startsWith("http")) {
            try {
                String host;
                ...
                casServerUrlPrefix = url.getProtocol() + "://" + host + casServerUrlPrefix;
        ...
        final StringBuilder buffer = new StringBuilder(urlParameters.size() * 10 + casServerUrlPrefix.length() + suffix.length() + 1);
